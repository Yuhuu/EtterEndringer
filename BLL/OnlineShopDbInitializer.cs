...
namespace OnlineWebShop.DAL
{
     ...
     public class OnlineShopDbInitializer : CreateDatabaseIfNotExists<OnlineStoreEntities>
  {
    protected override void Seed(OnlineStoreEntities context)
    {
     ...
     new List<Vare>
     {
       new Vare { ProduktNavn = "Model-2014-navesti", ProduktMerke = "navesti", Pris = 223M },
        new Vare { ProduktNavn = "Model-2011-apple", ProduktMerke = "Apple", Pris = 323M},
          new Vare { ProduktNavn = "Model-2005-navesti", ProduktMerke = "HTC", Pris = 3241M },
        new Vare { ProduktNavn = "Model-2014-vpl", ProduktMerke = "HP", Pris = 2344M },
          new Vare { ProduktNavn = "Model-2015-volve", ProduktMerke = "HTC", Pris = 2241M },
        new Vare { ProduktNavn = "Model-2014-naHPvesti", ProduktMerke = "HP", Pris = 24344M },
          new Vare { ProduktNavn = "Model-2015-Hifi", ProduktMerke = "HTC", Pris = 9241M },
        new Vare { ProduktNavn = "Model-2004-naHPvesti", ProduktMerke = "HP", Pris = 2344M },
          new Vare { ProduktNavn = "Model-2015-navesti", ProduktMerke = "HTC", Pris = 241M },
        new Vare { ProduktNavn = "Model-2017-naHPvesti", ProduktMerke = "HP", Pris = 2344M }
